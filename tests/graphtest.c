...
{
    Node node1 = graph_create_node(10);
    Node node2 = graph_create_node(30);
    Node node3 = graph_create_node(10);
    assert(graph_node_pool_size() == 3);
    assert(graph_edge_pool_size() == 0);
    assert(graph_node_pool_contains(&node1));
    assert(graph_node_pool_contains(&node2));
    assert(graph_node_pool_contains(&node3));
}
